...
const RESULT_BACKGROUNDS = {
  victory: {
    ...
    path: 'assets/Race/Results/victory_background.png?v=20260922-r103',
  },
  defeat: {
    key: 'raceResultDefeatBg',
    path: 'assets/Race/Results/defeat_background.png?v=20260922-r103',
  },
  pinkWin: {
    key: 'raceResultPinkWinBg',
    path: 'assets/Race/Results/pink_slip_won_background.png?v=20260922-r103',
  },
  pinkLoss: {
    key: 'raceResultPinkLossBg',
    path: 'assets/Race/Results/pink_slip_lost_background.png?v=20260922-r103',
  },
};
