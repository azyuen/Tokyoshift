export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    this.load.atlas(
      'tokyoShiftArt',
      'assets/tokyo_shift_atlas.webp',
      'assets/tokyo_shift_atlas.json'
    );
  }
  ...
  create() {
    ...
    this.add.text(640, 420, 'JDM street drag prototype', {
      fontFamily: 'monospace', fontSize: '15px', color: '#a8afc4'
    }).setOrigin(0.5);

    this.time.delayedCall(450, () => this.scene.start('RaceScene'));
  }
}
