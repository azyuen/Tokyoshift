...
import { createDefaultGameState, readManualSave, applyStateToRegistry } from '../state/GameState.js?v=20260921-r59';
...
export default class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(780, 425, saved ? 'LOADING SAVE // R59' : 'NEW RUN // R59', {
