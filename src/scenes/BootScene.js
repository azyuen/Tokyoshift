import { garageAssets } from '../data/garageAssets.js?v=20260922-r96';
...
import { createDefaultGameState, readManualSave, readSessionState, applyStateToRegistry } from '../state/GameState.js?v=20260922-r96';
