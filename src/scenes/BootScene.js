import { garageAssets } from '../data/garageAssets.js?v=20260921-r80';
...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // R80 paint test: these are optional until the user uploads the two PNGs.
    // CarAppearance falls back to carAE86 automatically if either layer is missing.
    this.load.image('carAE86Paint', 'assets/Cars/ae86_body_paint.png?v=20260921-r80');
    this.load.image('carAE86Overlay', 'assets/Cars/ae86_body_overlay.png?v=20260921-r80');
  ...
  create() {
    ...
    this.add.text(780, 425, saved ? 'LOADING SAVE // R80' : 'NEW RUN // R80', {
