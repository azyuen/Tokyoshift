...
import { preloadCarAppearanceAssets } from '../vehicles/CarAppearance.js?v=20260923-r154';
...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    preloadCarAppearanceAssets(this, cars, '20260923-r154');
    ...
    Object.values(cars).forEach(car => {
      ...
      if (
        ...
        this.load.image(
          visual.wheelKey,
          visual.wheelPath + '?v=20260923-r154'
        );
      }
    });
