import BootScene from './scenes/BootScene.js?v=20260922-r128';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260922-r127';
import GarageScene from './scenes/GarageScene.js?v=20260922-r129';
import CentralTokyoScene from './scenes/CentralTokyoScene.js?v=20260922-r128';
