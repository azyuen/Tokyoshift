import BootScene from './scenes/BootScene.js?v=20260922-r117';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260922-r119';
import GarageScene from './scenes/GarageScene.js?v=20260922-r119';
import MeetScene from './scenes/MeetScene.js?v=20260922-r118';
import RaceScene from './scenes/RaceScene.js?v=20260922-r117';
