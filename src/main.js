import BootScene from './scenes/BootScene.js?v=20260922-r112';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260922-r112';
import GarageScene from './scenes/GarageScene.js?v=20260922-r114';
import MeetScene from './scenes/MeetScene.js?v=20260922-r112';
import RaceScene from './scenes/RaceScene.js?v=20260922-r112';
