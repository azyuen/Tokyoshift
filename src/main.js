import BootScene from './scenes/BootScene.js?v=20260926-r203';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260926-r203';
import GarageScene from './scenes/GarageScene.js?v=20260926-r201';
import CentralTokyoScene from './scenes/CentralTokyoScene.js?v=20260926-r203';
import MeetScene from './scenes/MeetScene.js?v=20260926-r203';
import RaceScene from './scenes/RaceScene.js?v=20260926-r203';
import RunOverScene from './scenes/RunOverScene.js?v=20260926-r203';
import ResultScene from './scenes/ResultScene.js?v=20260924-r171';
import TunerShopScene from './scenes/TunerShopScene.js?v=20260926-r203';
...
const config = {
  ...
  scene: [BootScene, CharacterSelectScene, GarageScene, CentralTokyoScene, MeetScene, RaceScene, RunOverScene, ResultScene, TunerShopScene, ProfileCalibrationScene],
};
