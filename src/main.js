import BootScene from './scenes/BootScene.js?v=20260925-r198';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260925-r195';
import GarageScene from './scenes/GarageScene.js?v=20260925-r198';
import CentralTokyoScene from './scenes/CentralTokyoScene.js?v=20260925-r198';
import MeetScene from './scenes/MeetScene.js?v=20260925-r195';
import RaceScene from './scenes/RaceScene.js?v=20260925-r198';
import ResultScene from './scenes/ResultScene.js?v=20260924-r171';
import TunerShopScene from './scenes/TunerShopScene.js?v=20260925-r198';
