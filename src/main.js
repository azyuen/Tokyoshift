import BootScene from './scenes/BootScene.js?v=20260924-r173';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260924-r171';
import GarageScene from './scenes/GarageScene.js?v=20260924-r173';
...
import RaceScene from './scenes/RaceScene.js?v=20260924-r173';
import ResultScene from './scenes/ResultScene.js?v=20260924-r171';
import TunerShopScene from './scenes/TunerShopScene.js?v=20260924-r173';
