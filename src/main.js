import BootScene from './scenes/BootScene.js?v=20260926-r204';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260926-r204';
import GarageScene from './scenes/GarageScene.js?v=20260926-r206';
import CentralTokyoScene from './scenes/CentralTokyoScene.js?v=20260926-r206';
import MeetScene from './scenes/MeetScene.js?v=20260926-r206';
import RaceScene from './scenes/RaceScene.js?v=20260926-r207';
...
import TunerShopScene from './scenes/TunerShopScene.js?v=20260926-r204';
