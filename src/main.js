import BootScene from './scenes/BootScene.js?v=20260921-r39';
import GarageScene from './scenes/GarageScene.js?v=20260921-r39';
import MeetScene from './scenes/MeetScene.js?v=20260921-r39';
import RaceScene from './scenes/RaceScene.js?v=20260921-r39';
import ResultScene from './scenes/ResultScene.js?v=20260921-r39';
