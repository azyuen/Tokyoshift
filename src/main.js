import BootScene from './scenes/BootScene.js?v=20260922-r127';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260922-r127';
import GarageScene from './scenes/GarageScene.js?v=20260922-r127';
import CentralTokyoScene from './scenes/CentralTokyoScene.js?v=20260922-r127';
import MeetScene from './scenes/MeetScene.js?v=20260922-r127';
import RaceScene from './scenes/RaceScene.js?v=20260922-r127';
