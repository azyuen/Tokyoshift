import BootScene from './scenes/BootScene.js?v=20260922-r122';
import CharacterSelectScene from './scenes/CharacterSelectScene.js?v=20260922-r120';
import GarageScene from './scenes/GarageScene.js?v=20260922-r122';
import MeetScene from './scenes/MeetScene.js?v=20260922-r122';
