export const WORKSHOP_TIERS = [
  ...
  },
  {
    ...
    description: 'Lease a larger waterside tuning bay with room for twelve cars.',
  },
  {
    tier: 2,
    ...
    unlockCost: 450000,
    textureKey: 'garageWorkshopTunerBg',
    description: 'Take over a full warehouse and build an twenty-four-car tuning headquarters.',
  },
];
