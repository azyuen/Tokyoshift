            ...
            layers: [
              {
                ...
                paintMode: 'body',
                // Register the authored kit to the stock wheelbase/cabin.
                // Values are source-canvas pixels and are applied identically
                // to paint + details so the two layers remain locked together.
                scaleX: 1.021,
                scaleY: 1.021,
                offsetX: 6,
                offsetY: 13,
            ...
            layers: [
              {
                ...
                paintMode: 'body',
                // Body Kit 2 was authored with a longer wheelbase inside the
                // same canvas. Shrink around the shared canvas centre, then
                // translate it back onto the stock AE86 axle centres.
                scaleX: 0.940,
                scaleY: 0.940,
                offsetX: 64,
                offsetY: 29,
